...
ggsave('./03.Annotation.Result/Plot/2Y_Annotation.svg', plot = DimPlot(combinedh.2y, reduction = "umap") + scale_color_manual(values = brewer.pal(6, "Paired")), height = 10, width = 10, dpi = 500)
ggsave('./03.Annotation.Result/Plot/2Y_Annotation.jpg', plot = DimPlot(combinedh.2y, reduction = "umap") + scale_color_manual(values = brewer.pal(6, "Paired")), height = 10, width = 10, dpi = 500)
...
ggsave('./03.Annotation.Result/Plot/2Y_Annotation_split_nolegend.svg', plot = DimPlot(combinedh.2y, reduction = "umap", split.by = "split") + scale_color_manual(values = brewer.pal(6, "Paired")) + NoLegend(), height = 10, width = 10, dpi = 500)
ggsave('./03.Annotation.Result/Plot/2Y_Annotation_split_nolegend.jpg', plot = DimPlot(combinedh.2y, reduction = "umap", split.by = "split") + scale_color_manual(values = brewer.pal(6, "Paired")) + NoLegend(), height = 10, width = 10, dpi = 500)
...
ggsave('./03.Annotation.Result/Plot/2Y_Annotation_split.svg', plot = DimPlot(combinedh.2y, reduction = "umap", split.by = "split") + scale_color_manual(values = brewer.pal(6, "Paired")) , height = 10, width = 10, dpi = 500)
ggsave('./03.Annotation.Result/Plot/2Y_Annotation_split.jpg', plot = DimPlot(combinedh.2y, reduction = "umap", split.by = "split") + scale_color_manual(values = brewer.pal(6, "Paired")) , height = 10, width = 10, dpi = 500)
...
ggsave('./03.Annotation.Result/Plot/2Y_CelltypePercentage_nolegend.svg', plot = Per1, height = 10, width = 10, dpi = 500)
ggsave('./03.Annotation.Result/Plot/2Y_CelltypePercentage_nolegend.jpg', plot = Per1, height = 10, width = 10, dpi = 500)
...
ggsave('./03.Annotation.Result/Plot/2Y_CelltypePercentage.svg', plot = Per2, height = 10, width = 10, dpi = 500)
ggsave('./03.Annotation.Result/Plot/2Y_CelltypePercentage.jpg', plot = Per2, height = 10, width = 10, dpi = 500)
...
Per3 = ggplot(cell_count, aes(x=CellType, y=Group, fill=Percentage)) +
  ...
  theme(plot.title = element_text(hjust = 0.5, size=16),
        ...
        axis.title.y = element_text(size=14))
Per3
ggsave('./03.Annotation.Result/Plot/2Y_CelltypePercentage_Compare.svg', plot = Per3, height = 10, width = 10, dpi = 500)
ggsave('./03.Annotation.Result/Plot/2Y_CelltypePercentage_Compare.jpg', plot = Per3, height = 10, width = 10, dpi = 500)
