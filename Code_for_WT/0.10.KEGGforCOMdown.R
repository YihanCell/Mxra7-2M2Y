...
goenrichment = function(cell_type){
  ...
  write.csv(kegg.histogram.down, paste0("/data/yihan/Mxra7_2m/Result_for_WT/07.Enrichment.Result.KEGG/",cell_type,".down_gene.KEGG.csv"))
  ...
  kegg.plot.down
  ggsave(paste0("./Result_for_WT/07.Enrichment.Result.KEGG/", cell_type, ".down_gene.KEGG.pdf"), plot = kegg.plot.down)
}
