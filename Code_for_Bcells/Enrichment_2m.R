...
markers = read.delim("./Result_for_X/06/B_cells.control_treat.glmLRT.plot.txt", row.names = 1, sep = '\t', check.names = FALSE)
...
ggsave("/data/yihan/Mxra7_2m/Result_for_Bcells/2m_all_gene.KEGG_new.pdf", plot = kegg.plot.down)
